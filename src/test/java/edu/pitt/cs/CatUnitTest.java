...
public class CatUnitTest {
	...
	public void testGetId() {
		int id = c.getId();
		assertEquals("The return value of getId is incorrect.", 1, c.getId());
	}
	...
	public void testGetName() {
		// TODO: Fill in
		assertEquals("Did not correctly return cat name.","Jennyanydots", c.getName());
	}
	...
	public void testGetRented() {
		// TODO: Fill in
		assertEquals("Rent status incorrect.", false, c.getRented());
	...
	public void testToString() {
		// TODO: Fill in
		assertEquals("Cat toString incorrect.", "ID 1. Jennyanydots", c.toString());
	}
	...
	public void testRentCat() {
		// TODO: Fill in
		c.rentCat();
		assertEquals("Rent status incorrect.", true, c.getRented());
	}
	...
	public void testRenameCat() {
		...
		assertEquals("Did not correctly return cat name.","Garfield", c.getName());
	}
